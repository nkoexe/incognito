...
public class Connection {
  ...
  public synchronized void handlePrivateChatRequest(ClientHandler requester, String sessionId,
    ...
    if (pendingPrivateChats.containsKey(sessionId)) {
      ...
      ChatSessionLogger.logInfo("Private chat session " + sessionId + " created between " + requesterUsername + " and "
  ...
  public void forwardPrivateMessage(ClientHandler sender, ChatMessage message) {
    ...
    if (sessionId == null) {
      ...
      ChatSessionLogger
          .logWarning("User " + senderUsername + " tried to send a private message without being in a session.");
    ...
    if (recipient != null) {
      ...
      ChatSessionLogger.logInfo("Forwarded private message from " + senderUsername + " to " + recipient.getUsername()
